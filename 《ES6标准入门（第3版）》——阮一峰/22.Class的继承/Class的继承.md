...
[2. Object.getPrototypeOf()](#2-Object.getPrototypeOf())

[3. super 关键字](#3-super关键字)

[4. 类的 prototype 属性和__proto__属性](#4-类的prototype属性和__proto__属性)

[5. 原生构造函数的继承](#5-原生构造函数的继承)

[6. Mixin 模式的实现](#6-Mixin模式的实现)
