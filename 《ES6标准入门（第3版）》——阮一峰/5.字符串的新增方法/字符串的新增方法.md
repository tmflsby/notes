...
[1. String.fromCodePoint()](#1-String.fromCodePoint())

[2. String.raw()](#2-String.raw())

[3. 实例方法：codePointAt()](#3-实例方法：codePointAt())

[4. 实例方法：normalize()](#4-实例方法：normalize())

[5. 实例方法：includes(), startsWith(), endsWith()](#5-实例方法：includes(),startsWith(),endsWith())

[6. 实例方法：repeat()](#6-实例方法：repeat())

[7. 实例方法：padStart(), padEnd()](#7-实例方法：padStart(),padEnd())

[8. 实例方法：trimStart(), trimEnd()](#8-实例方法：trimStart(),trimEnd())

[9. 实例方法：matchAll()](#9-实例方法：matchAll())
