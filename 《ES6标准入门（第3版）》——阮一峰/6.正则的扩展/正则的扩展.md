...
[1. RegExp 构造函数](#1-RegExp构造函数)

[2. 字符串的正则方法](#2-字符串的正则方法)

[3. u 修饰符](#3-u修饰符)

[4. RegExp.prototype.unicode 属性](#4-RegExp.prototype.unicode属性)

[5. y 修饰符](#5-y修饰符)

[6. RegExp.prototype.sticky 属性](#6-RegExp.prototype.sticky属性)

[7. RegExp.prototype.flags 属性](#7-RegExp.prototype.flags属性)

[8. s 修饰符：dotAll 模式](#8-s修饰符：dotAll模式)

[9. 后行断言](#9-后行断言)

[10. Unicode 属性类](#10-Unicode属性类)

[11. 具名组匹配](#11-具名组匹配)

[12. 正则匹配索引](#12-正则匹配索引)

[13. String.prototype.matchAll()](#13-String.prototype.matchAll())
