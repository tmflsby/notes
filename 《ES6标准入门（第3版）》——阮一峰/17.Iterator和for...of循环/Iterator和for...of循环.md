...
[1. Iterator（遍历器）的概念](#1-Iterator（遍历器）的概念)

[2. 默认 Iterator 接口](#2-默认Iterator接口)

[3. 调用 Iterator 接口的场合](#3-调用Iterator接口的场合)

[4. 字符串的 Iterator 接口](#4-字符串的Iterator接口)

[5. Iterator 接口与 Generator 函数](#5-Iterator接口与Generator函数)

[6. 遍历器对象的 return(),throw()](#6-遍历器对象的return(),throw())

[7. for...of 循环](#7-for...of循环)
